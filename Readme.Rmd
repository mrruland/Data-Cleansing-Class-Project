...
and gyroscope, the team captured 3-axial linear acceleration and 3-axial angular 
velocity measurements at a constant rate of 50Hz. The experiments were video-recorded to 
help label the activity occurring when the data was collected manually. The 
...
*http://www.jstatsoft.org/v59/i10/paper* and David Hood's discussions in the class
forum at *https://class.coursera.org/getdata-012/forum/thread?thread_id=234*.  
...
subject 1, standing) are on a single row.  I allow the user to optionally create
the long version of the tidy data set as well by modifying the *"long"* 
...
**wide** or **long**, depending on the option chosen.
